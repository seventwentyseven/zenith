...
const Score = ({ score }: { score: IScore }) => {
  return (
    <div className="w-full h-24 flex group">
      <div
        className="bg-hsl-10 flex flex-row items-center justify-between px-4 rounded-xl min-w-full h-full transition duration-300 bg-center bg-cover group-hover:-translate-x-12"
        style={{
      ...
      >
        <div className="flex flex-col gap-2 text-hsl-90">
        ...
        <div className="flex flex-row items-center gap-4 text-hsl-90">
          ...
          <span className="text-5xl w-16 h-full">
      ...
      <Link
        ...
        className="w-12 h-full opacity-0 scale-0 flex translate-x-0 group-hover:scale-100 transition group-hover:opacity-100 group-hover:-translate-x-7 duration-300 items-center justify-center"
      >
        <FaBars />
      </Link>
    </div>
