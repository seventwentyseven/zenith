...
const BadgeDeveloper = () => {
  return (
    <>
      <span
        className="inline-flex items-center rounded-full px-2.5 py-2 bg-gradient-to-br from-purple-700 to-fuchsia-700 text-purple-100 group transition-all duration-300"
        role="alert"
        tabIndex={0}
      >
