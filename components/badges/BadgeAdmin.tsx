...
const BadgeAdmin = () => {
  return (
    <>
      <span
        className="inline-flex items-center rounded-full px-2.5 py-2 bg-gradient-to-br from-yellow-600 to-amber-400 text-yellow-100 group transition-all duration-300 select-none"
        role="alert"
        tabIndex={0}
      >
